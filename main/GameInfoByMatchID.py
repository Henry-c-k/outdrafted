...
from cassiopeia import Summoner, FeaturedMatches, Champion, ChampionMastery, Queue, Position, Rank, Match
...
def get_match_data(match_id: str, region: str):
    ...
    current_match = Match(id=str(match_id), region=region)
    print(current_match.region)
    print("Red Team Won: ", int(current_match.red_team.win))
    ...
    for participant in current_match.blue_team.participants:
        ...
        cm = cass.get_champion_mastery(champion=participant.champion, summoner=participant.summoner, region=region)
...
if __name__ == "__main__":
    ...
    get_match_data("EUW1_5825785970", "EUW")
